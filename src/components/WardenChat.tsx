...
export const WardenChat: React.FC<WardenChatProps> = ({
  ...
  const modeActions: Record<AgentMode, { label: string; text: string; icon: React.ReactNode }[]> = {
    linkedin: [
      { label: 'Turn project into LinkedIn post', text: 'I built a real-time AI moderation agent using Google Gemini 2.5 Flash and fine-tuned Qwen-1.5B QLoRA. Turned latency to 125ms and stopped 95% of scams.', icon: <Briefcase className="w-3.5 h-3.5 text-sky-400 mr-1.5 inline" /> },
