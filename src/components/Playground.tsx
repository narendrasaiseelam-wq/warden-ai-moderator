        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-bold text-white tracking-tight">
              Interactive Safety Playground (Gemini 3.6 Flash Agent)
            </h2>
          </div>
      ...
      {isLoading && (
        <div className="p-5 rounded-xl bg-gray-950/90 border border-emerald-500/30 animate-pulse space-y-3">
          <div className="flex items-center gap-2 text-xs font-mono text-emerald-400">
            ...
            <span>Warden Agent is running Google Gemini 3.6 Flash contextual evaluation...</span>
          </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  Category: <span className="font-semibold text-gray-200">{currentResult.category}</span> • Engine: <span className="font-mono text-cyan-400 font-bold">Gemini 3.6 Flash</span> ({currentResult.latencyMs || 140}ms)
                </p>
              </div>
            </div>
          ...
          <div className="pt-2 border-t border-gray-800/80">
            ...
            >
              <span className="flex items-center gap-1.5">
                ...
                Inspect Agent Reasoning &amp; Model Trace (Qwen QLoRA + Gemini 3.6 Flash)
              </span>
